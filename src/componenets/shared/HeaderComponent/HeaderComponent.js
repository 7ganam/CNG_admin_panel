    ...
    render() {
        return (
            <div className={this.state.nav_class_name}>
                <Navbar light className="light py-1  border-bottom fixed-top p-5" expand="xl">
                    <div style={{
                        position: "relative",
                        top: ""
                    }} >
                    ...
                    <Collapse className="justify-content-end" isOpen={this.state.isNavOpen} navbar>
                        ...
                        <Nav style={{}} className="ml-4 ml-xl-auto" navbar>
                            ...
                            <NavItem onClick={this.closeNav} className=''>
                                <Link to="/HELP">
                                    <div className="nav-link" to='/WORKSPACESVIEW'><span className="fa fa-address-card fa-lg"></span>  HELP</div>
                                </Link>
                            </NavItem>
                ...
                <div className="nav_icon">
                    <img src='/logo.png' alt='l' style={{ width: "80%", height: '80%' }} />
                </div>
